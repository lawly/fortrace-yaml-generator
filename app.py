...
from agents.persona_agent import PersonaAgent
from agents.persona_with_mail_agent import PersonaWithMailAgent
...
def initialize_assistant():
    ...
    st.session_state.scenario_agent = ScenarioAgent(
        ...
        PersonaWithMailAgent(model=get_model(st.session_state['0_model'], st.session_state['0_temperature']), prompt=st.session_state.persona_mail_gemini_prompt),
